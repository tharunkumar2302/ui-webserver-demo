...
import { getMenuAccessDetails } from "../../redux/actions/CommonActions";
...
const MatxVerticalNav = ({ items }) => {
  ...
  useEffect(() => {
    getMenuAccessDetails().then((users) => setMenu(users.payload));
  }, []);

  const renderLevels = (data) => {
    // eslint-disable-next-line array-callback-return
    return data.map((item, index) => {
      menu[index]?.key != undefined && menuKey.push(menu[index]?.key)
